...
eval(strcat("mex ./lahbpcg_mex.cpp ", filelist, " -I/usr/local/include -L/usr/local/lib -L/opt/homebrew/Cellar/fftw/3.3.10_1/lib -DNO_SDL -DNO_OPENEXR -DNO_TIFF -DNO_JPEG -DNO_PNG -lfftw3f -ldl -R2018a"))
